...
export default function ProgressionLibraryTable({
  rows,
  total,
  page,
  pageSize,
  ...
  return (
    <div className="card-flex">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold mb-3">Progression Library</h2>
      ...
      {!slice || slice.length===0 ? (
        <p className="text-slate-300">No progression plans yet.</p>
      ) : (
